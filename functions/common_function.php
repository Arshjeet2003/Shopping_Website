<?php
                ...
                if(!isset($_GET['brand'])){
                    ...
                    while($row=mysqli_fetch_assoc($result_query)){
                        ...
                        <img src='./admin_area/product_images/$product_image1' class='card-img-top' alt='$product_title'>
                            ...
                            <div class='col-md-8'>
                            <div class='row'>
                            <!-- Sum should be equal to 12 (4,8) if we use class row -->
                                <div class='col-md-12'>
    ...
    function cart(){
        if(isset($_GET['add_to_cart'])){
            ...
            $num_of_rows=mysqli_num_rows($result_query);
            if($num_of_rows>0){
                echo "<script>alert('Item already preset in cart')</script>";
                // redirecting to index.php , _self for same tab.
        ...
        while($row_query=mysqli_fetch_array($result_query)){
            ...
            if(!isset($_GET['edit_account']) && !isset($_GET['my_orders']) && !isset($_GET['delete_account'])){
                ...
                if($row_count>0){
                    ...
                    You have <span class='text-danger'>
                    ...
                    echo "<h3 class='text-center text-success mt-5 mb-2'>
                    You have zero pending orders</h3>
